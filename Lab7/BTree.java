...
public class BTree {
    ...
    private static class Node {
        ...
        int[] key;                      // the array that holds the keys value.
        Node[] children;                // the array that holds the references of the keys in the node.
        boolean isLeaf;                   // the variable to deterime if the node is is Leaf or not.
